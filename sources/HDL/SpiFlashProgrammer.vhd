...
entity SpiFlashProgrammer is
  ...
  (
    ...
    isQuadRead          : out std_logic;
    isQuadWrite         : out std_logic;
...
architecture behavioral of SpiFlashProgrammer is
  ...
  constant  cMicronN25Q       : std_logic := '0'; -- Micron N25Q serial NOR flash
  ...
  constant  cSpansionS25FS    : std_logic := '1'; -- Spansion S25FS (NOT TESTED)
  -- SPI COMMAND ADDRESS WIDTH (IN BITS): Ensure setting is correct for the target flash
  constant  cAddrWidth        : integer   := 32;  -- 24 or 32 (address width in bits)
  -- SPI SECTOR SIZE (IN BYTES)
  constant  cSizeSector       : std_logic_vector(31 downto 0) := X"00040000"; -- 262144 bytes
  -- SPI PAGE SIZE (IN BYTES): Ensure setting is correct for the chosen device type.
  constant  cSizePage         : std_logic_vector(31 downto 0) := X"00000200"; -- 512 (std)
  constant  cSizePageNP5Q     : std_logic_vector(31 downto 0) := X"00000040"; -- 64
  -- UPDATE IMAGE START (BYTE) ADDRESS
  constant  cAddrUpdateStart  : std_logic_vector(31 downto 0) := X"00B40000";
  -- UPDATE IMAGE END+1 (BYTE) ADDRESS
  constant  cAddrUpdateEnd    : std_logic_vector(31 downto 0) := X"01640000";
  -- SWITCH WORD (BYTE) ADDRESS: Ensure setting is correct for the chosen device type
  constant  cAddrSwitchWordN25Q : std_logic_vector(31 downto 0) := X"0003FFFC"; -- Typically=(Subsector or page) size - 4.
  ...
  constant  cIdcode24S25FS    : std_logic_vector(23 downto 0) := X"010219"; -- datasheet page 134
  -- Device command opcodes
  constant  cCmdREAD24        : std_logic_vector(7 downto 0)  := X"03";
  constant  cCmdREAD32        : std_logic_vector(7 downto 0)  := X"13";
  constant  cCmdQOR32         : std_logic_vector(7 downto 0)  := X"6C"; --quad out read
  ...
  constant  cCmdQPP32         : std_logic_vector(7 downto 0)  := X"34";
  ...
  constant  cCmdWRR          : std_logic_vector(7 downto 0)   := X"01"; -- Legacy write configuration register
  constant  cCmdRDCR          : std_logic_vector(7 downto 0)  := X"35"; -- Legacy read configuration register
  ...
  constant  cCmdSETimeOut     : std_logic_vector(31 downto 0) := X"09AF8DA0"; -- max tSE * cClkFrequencyHz / 22
  ...
  signal  regVerify       : std_logic                     := '0';
  signal  regChangeModeOnly       : std_logic                     := '0';
  ...
  signal  regModeChangeOK: std_logic                   := '0';
  ...
  signal dummyCycle : integer range 0 to 8;
  ...
  (
    ...
    sProgrammerEraseSwitchWord,sProgrammerChangeMode,
    sProgrammerChangeMode1,sProgrammerChangeMode2,
    ...
    sProgrammerPollStatus, sProgrammerPollStatus1,sProgrammerVerifyUpdateArea11,
...
begin
      ...
      if (inReset_EnableB='1') then
        ...
        case (stateProgrammer) is
          ...
          when sProgrammerInitialize =>
            ...
            regChangeModeOnly       <= inChangeModeOnly;
          ...
          when sProgrammerCheckId1 =>
            if ((cMicronNP5Q='1') and (regData40(23 downto 8) /= cIdcode24NP5Q(23 downto 8))) then
              ...
              elsif regChangeModeOnly = '1' then
                stateProgrammer <= sProgrammerChangeMode;
          ...
          when sProgrammerEraseSwitchWord =>
            ...
            if (cMicronNP5Q = '1') then
              ...
              regData40                 <= cCmdSE32 & cAddrSwitchWordN25Q;
              regCounter3               <= "101";
            else
          ...
          when sProgrammerProgramUpdateArea1 =>
            ...
            -- Send PP
            if (cAddrWidth=32) then
              regData40                 <= cCmdQPP32 & regCounter32;
              regCounter3               <= "101";
          ...
          when sProgrammerVerifyUpdateArea1 =>
            if (cAddrWidth=32) then
              regData40                 <= cCmdQOR32 & regCounter32;
              regCounter3               <= "101";
            else
          ...
          when sProgrammerVerifyUpdateArea11 =>
            ...
            isQuadRead <= '1';
            dummyCycle <= dummyCycle + 1;
            if dummyCycle = 6 then
          ...
          when sProgrammerChangeMode => 
            stateProgrammer     <= sProgrammerSendWEAndWord;
            stateAfterSendWord <= sProgrammerPollStatus;
            stateAfterPollStatus <= sProgrammerChangeMode1;
            regTimer                    <= cCmdSETimeOut;
            stateErrorTimeOut           <= sProgrammerErrorProgramTO;
  ...
  outModeChangeOK     <= regModeChangeOK;
